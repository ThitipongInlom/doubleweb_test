$(document).ready(function () {
    ...
    $('#member_table').DataTable({
        ...
        "ajax": {
            "url": 'server/datatables/server_crud_member.php',
            "type": 'get'
        },
        "columns": [{
            "data": '0',
...
var view_data_modal = function view_data_modal(e) {
    ...
    $.ajax({
        type: 'POST',
        url: 'server/crud_member.php?action=Get_user',
        dataType: 'json',
        cache: false,
        contentType: false,
        processData: false,
...
var Edit_data_modal = function Edit_data_modal(e) {
    ...
    $.ajax({
        type: 'POST',
        url: 'server/crud_member.php?action=Get_edit_user',
        dataType: 'json',
        cache: false,
        contentType: false,
        processData: false,
...
var Save_Edit = function Save_Edit(e) {
    ...
    if (Check_input == true) {
        ...
        $.ajax({
            type: 'POST',
            url: 'server/crud_member.php?action=Save_edit_user',
            dataType: 'json',
            cache: false,
            contentType: false,
            processData: false,
...
var Save_Delete = function Save_Delete(e) {
    ...
    Data.append($("#player_id").attr('name'), $(e).attr('member_id'));
        $.ajax({
            type: 'POST',
            url: 'server/crud_member.php?action=Save_delete_user',
            dataType: 'json',
            cache: false,
            contentType: false,
            processData: false,
